      ...
      {translatedText && (
        <div className='p-4 border rounded bg-white shadow'>
          ...
          <div className='text-sm space-y-1'>
            {showChildSafety && (
              <p><strong>⚠️ Safety Note:</strong> Warning: Not suitable for children under 3.</p>
            )}
            {showHalalWarnings && (
              <p><strong>🚫 Dietary Alert:</strong> Contains Alcohol, Gelatin (Not Halal or Kosher)</p>
            )}
            {showVeganAlerts && (
              <p><strong>🥦 Vegan Note:</strong> Contains Gelatin (Not Vegan)</p>
            )}
            {showGlutenFree && (
              <p><strong>🌾 Gluten-Free Check:</strong> No gluten-containing ingredients listed</p>
            )}
